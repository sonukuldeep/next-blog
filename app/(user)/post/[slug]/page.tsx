    ...
    return (
        <section className='px-10 pb-20'>
            <article className='space-y-2 text-white justify-between'>
                {/* <div className='relative max-h-56 flex flex-col md:flex-row'>
                    <div className='absolute w-full h-full opacity-10 p-10'>
                        <Image className='object-cover object-center mx-auto' src={urlFor(post.mainImage).url()} alt="main image" fill />
                    </div>
                </div> */}
                <article className='relative p-5 bg-yellow-700 bg-opacity-30 w-full rounded'>
                    <div className='absolute w-full h-full opacity-10 top-0 left-0 blur-sm'>
                        <Image className='object-cover object-center' src={urlFor(post.mainImage).url()} alt="main image" fill />
                    </div>
